...
/**
 * Defines the available message types that can be streamed to Band.
...
export const MESSAGE_TYPES_NODE_PROPERTY: INodeProperties = {
	...
	description: 'Select which types of messages to stream to Band during agent execution',
};
...
const CHAT_ID_PROPERTY: INodeProperties = {
	...
	description: 'The ID of the Band chat room to stream agent activity to',
};
...
const MESSAGE_HISTORY_SOURCE_PROPERTY: INodeProperties = {
	...
	options: [
		...
		},
		{
			name: 'From API',
			value: 'api',
			description: 'Fetch recent messages from Band API',
		},
	],
	default: 'memory',
