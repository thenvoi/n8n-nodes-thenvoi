 ...
 *   - additional_kwargs.band_structured_data: Structured object containing:
...
export interface BandMemoryInput extends BaseChatMemoryInput {
	/**
...
/**
 * Band memory class that wraps existing LangChain memory
 *
...
export class BandMemory extends BaseChatMemory {
	...
	private enrichAIMessageWithStructuredData(
		...
		if (isAIMessage(lastMessage)) {
			...
			enrichable.additional_kwargs = {
				...enrichable.additional_kwargs,
				band_structured_data: structuredData,
			};
		}
	}
